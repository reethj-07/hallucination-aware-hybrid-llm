...
def run_retrieval_eval():
    ...
    if not os.path.exists(index_path) or not os.path.exists(docs_path):
        print("❌ FAISS index not found. Run: python -m rag.ingest_docs --force-reingest")
        return
    ...
    with open("results/retrieval_results_v2.json", "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2)
    print("💾 Results saved to results/retrieval_results_v2.json\n")
